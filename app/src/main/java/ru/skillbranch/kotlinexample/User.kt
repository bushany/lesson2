...
import ru.skillbranch.kotlinexample.UserHolder.cleanPhoneNumber
...
class User private constructor(
    ...
    private fun String.md5(): String {
        ...
        return hexString.padStart(32, 'o')
    }
            ...
            return split(" ")
                ...
                .run {
                    when (size) {
                        1 -> first() to null
                        2 -> first() to last()
                        else -> throw IllegalArgumentException("Full name must contain only fist name and last name, current split result ${this@fullNameToPair}")
                    }
                }
        }
    }
